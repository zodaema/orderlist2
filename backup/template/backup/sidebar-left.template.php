<div class="sticky">
    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="?p=dashboard">
                <img src="template/sash/assets/images/brand/logo.png" class="header-brand-img desktop-logo" alt="logo">
                <img src="template/sash/assets/images/brand/logo-1.png" class="header-brand-img toggle-logo" alt="logo">
                <img src="template/sash/assets/images/brand/logo-2.png" class="header-brand-img light-logo" alt="logo">
                <img src="template/sash/assets/images/brand/logo-3.png" class="header-brand-img light-logo1" alt="logo">
            </a>
            <!-- LOGO -->
        </div>
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="?p=dashboard"><i class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Dashboard</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="?p=orders"><i class="side-menu__icon fe fe-shopping-bag"></i><span class="side-menu__label">Orders</span></a>
                </li>
                <!-- <li class="sub-category">
                    <h3>UI Kit</h3>
                </li>
