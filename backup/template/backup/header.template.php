...
?>
    ...
    <div id="global-loader">
        <img src="template/sash/assets/images/loader.svg" class="loader-img" alt="Loader">
    </div>
    <!-- /GLOBAL-LOADER -->
	...
	<div class="container-fluid main-container">
		<div class="d-flex">
			<a id="toggle-sidebar-button" aria-label="Hide Sidebar" class="app-sidebar__toggle" data-bs-toggle="sidebar" href="javascript:void(0)"></a>
			<!-- sidebar-toggle-->
			<a class="logo-horizontal " href="index.html">
				<img src="template/sash/assets/images/brand/logo.png" class="header-brand-img desktop-logo" alt="logo">
				<img src="template/sash/assets/images/brand/logo-3.png" class="header-brand-img light-logo1"
					alt="logo">
			</a>
			<!-- LOGO -->
						...
						<div class="d-flex order-lg-2">
									...
									<div class="header-dropdown-list message-menu">
										<div class="dropdown-item d-flex p-4">
											...
											<span
												...
												data-bs-image-src="template/sash/assets/images/pngs/4.jpg"></span>
											<div class="wd-50p">
										...
										<div class="dropdown-item d-flex p-4">
											...
											<span
												class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
												data-bs-image-src="template/sash/assets/images/pngs/6.jpg"></span>
											<div class="wd-50p">
										...
										<div class="dropdown-item d-flex p-4">
											...
											<span
												class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
												data-bs-image-src="template/sash/assets/images/pngs/8.jpg"></span>
											<div class="wd-50p">
										...
										<div class="dropdown-item d-flex p-4">
											...
											<span
												class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
												data-bs-image-src="template/sash/assets/images/pngs/1.jpg"></span>
											<div class="wd-50p">
										...
										<div class="dropdown-item d-flex p-4">
											...
											<span
												class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
												data-bs-image-src="template/sash/assets/images/pngs/3.jpg"></span>
											<div class="wd-50p">
									...
									<div class="message-menu message-menu-scroll">
										<a class="dropdown-item d-flex" href="chat.html">
											<span
												...
												data-bs-image-src="template/sash/assets/images/users/1.jpg"></span>
											<div class="wd-90p">
												<div class="d-flex">
										...
										<a class="dropdown-item d-flex" href="chat.html">
											<span
												class="avatar avatar-md brround me-3 align-self-center cover-image"
												data-bs-image-src="template/sash/assets/images/users/15.jpg"></span>
											<div class="wd-90p">
												<div class="d-flex">
										...
										<a class="dropdown-item d-flex" href="chat.html">
											<span
												class="avatar avatar-md brround me-3 align-self-center cover-image"
												data-bs-image-src="template/sash/assets/images/users/12.jpg"></span>
											<div class="wd-90p">
												<div class="d-flex">
										...
										<a class="dropdown-item d-flex" href="chat.html">
											<span
												class="avatar avatar-md brround me-3 align-self-center cover-image"
												data-bs-image-src="template/sash/assets/images/users/4.jpg"></span>
											<div class="wd-90p">
												<div class="d-flex">
										...
										<a class="dropdown-item d-flex" href="chat.html">
											<span
												class="avatar avatar-md brround me-3 align-self-center cover-image"
												data-bs-image-src="template/sash/assets/images/users/3.jpg"></span>
											<div class="wd-90p">
												<div class="d-flex">
							...
							<div class="dropdown d-flex profile-1">
								<a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
									<img src="template/sash/assets/images/users/21.jpg" alt="profile-user"
									...
									<div class="drop-heading">
										<div class="text-center">
											...
											<small class="text-muted">
												<?php
													$member_row['group'] = account_group_by_id($member_row);
